...
const Filter = ({ isClosing, setIsClosing }: { isClosing: boolean, setIsClosing: React.Dispatch<React.SetStateAction<boolean>> }) => {
  ...
  return (
    <div
      className="fixed top-0 left-0 w-full h-screen md:h-fit lg:relative lg:max-w-[1140px] px-4 pt-16 pb-4 lg:py-0 mx-auto text-font-color bg-backgrond-color md:shadow-md lg:shadow-none overflow-y-scroll md:overflow-y-auto"
      style={{
    ...
    >
      ...
      <div className="fixed bottom-0 left-0 md:relative flex flex-row justify-between lg:justify-end w-full px-4 md:px-6 py-4 lg:px-4 lg:py-3 lg:-translate-y-full md:text-end md:pointer-events-none bg-backgrond-color z-10 md:bg-transparent md:z-0 shadow-[0_-1px_16px_-1px_rgba(0,0,0,0.2)] md:shadow-none">
        <button
